...
public class KHeartTrigger : MonoBehaviour
{
    public Image image;
    public ParticleSystem heartParticles;
    public GameObject kHeartPrefab;
    public GameObject spawnGO;
    public Transform spawnPoint;

    private bool hasFaded = false;
    private bool KRight = false;
    private bool KLeft = false;
    ...
    IEnumerator SpawnImage()
    {
        ...
        while (true)
        {
            ...
            yield return new WaitUntil(() => KLeft || KRight);
            ...
            while (!(KLeft || KRight) && gestureFiller != null)
            {
